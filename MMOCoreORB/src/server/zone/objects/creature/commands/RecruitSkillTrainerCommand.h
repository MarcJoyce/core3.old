...
public:
	...
	int doQueueCommand(CreatureObject* creature, const uint64& target, const UnicodeString& arguments) const {
		...
		suiTrainerType->addMenuItem("@city/city:st_informant1", 33);
		suiTrainerType->addMenuItem("@city/city:st_informant2", 34);
		suiTrainerType->addMenuItem("@city/city:st_informant3", 35);
